...
with col1:
    ...
    st.write("I'm an aspiring Data Scientist and have been active on Kaggle for a year now. I'm a Kaggle Notebook Expert, ranking in the top 300 globally. With a strong foundation in programming languages like Python, Java, and R, I excel in machine learning models using TensorFlow and PyTorch. My expertise in NLP, Deep Learning, and Large Language Models enables me to derive meaningful insights from unstructured data. Additionally, I'm proficient in Computer Vision with OpenCV and Mediapipe, and I've successfully handled Big Data using PySpark.")
