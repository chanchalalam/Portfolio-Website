...
genai.configure(api_key="AIzaSyDmLQGxkLgyAUsUgofcK9kQBuVtLZUpy34")
...
This project aims to optimize the recruitment process. It integrates an advanced Applicant Tracking System with Google Gemini Pro, streamlining resume parsing, keyword matching, and candidate evaluation for an efficient end-to-end solution in talent acquisition.
Math With Gesture
...
This project involves predicting multiple diseases such as Diabetes, Heart disease, Kidney disease, Breast cancer, Liver disease, Malaria, and Pneumonia using machine learning and deep learning algorithms. It includes a web application for predicting multiple diseases using these algorithms.
